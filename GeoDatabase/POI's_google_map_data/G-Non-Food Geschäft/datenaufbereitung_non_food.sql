...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_non_food using GIST(geo_point_lv95);
...
where 
    rn = 1
;
-- select * from tmp_google_map_non_food_v1;
...
update tmp_google_map_non_food_V1
set 
...
--=====================================
drop table if exists 
	google_maps_dev.google_map_non_food_v1;
...
update google_maps_dev.google_map_non_food
set 
	korr_plz4 = '8004'
where 
...
drop table if exists 
	google_maps_dev_abgleich.google_abgleich_non_food;
...
--POIS: AFO
drop table if exists
	google_maps_dev_abgleich.afo_poi_typ_non_food;
...
(
	'google_maps_dev_abgleich.afo_poi_typ_non_food'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_non_food'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_non_food_tot'			-- abgleich_output_table
)
;
	...
	aws_s3.query_export_to_s3(
		...
		', 
   		aws_commons.create_s3_uri(
   			...
   			'google_maps_dev_abgleich/poi_abgleich_google_non_food_tot.csv', 
   			'eu-central-1'
   		),
