...
-- pois number: 18650
create temp table 
	tmp_gesundheit_category_v1
as
select 
	*
from 
	google_maps_dev.google_map_items_gesundheit_all t0
where 
	category_ids = 'null'
	or
	exists (
	    ...
	    where
	    	...
	    	and 
	    	t2.hauptkategorie_neu = 'Gesundheit'
	)  
;
...
/*
drop table if exists
	tmp_google_map_<HAUPTKATEGORIE>;
...
select
	*
from 
	google_maps_dev.google_map_<HAUPTKATEGORIE>
;
*/
...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_gesundheit using GIST(geo_point_lv95);
...
where 
    rn = 1
;
-- select * from tmp_google_map_gesundheit_v1;
...
update 
	tmp_google_map_gesundheit_V1 t0
set 
...
--=====================================
drop table if exists 
	google_maps_dev.google_map_gesundheit_v1;
...
/* Test and Adjust
select * from google_maps_dev.google_map_gesundheit_v1 order by random() limit 100;
...
update google_maps_dev.google_map_gesundheit
set 
	korr_plz4 = '8004'
where 
...
drop table if exists 
	google_maps_dev_abgleich.google_abgleich_gesundheit;
...
--POIS: Google gesundheit
/*
select * from google_maps_dev_abgleich.google_abgleich_gesundheit order by random() limit 100;

select count(*) from google_maps_dev_abgleich.google_abgleich_gesundheit;
*/

	
--POIS: AFO
create table 
	google_maps_dev_abgleich.afo_poi_typ_gesundheit
as
select 
	*
from 
...
/*
select * from google_maps_dev_abgleich.afo_poi_typ_gesundheit order by random() limit 100;

select count(*) from google_maps_dev_abgleich.afo_poi_typ_gesundheit;
*/
...
(
	'google_maps_dev_abgleich.afo_poi_typ_gesundheit'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_gesundheit'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_gesundheit_tot'			-- abgleich_output_table
)
;

/*
select * from google_maps_dev_abgleich.poi_abgleich_google_gesundheit_tot order by dubletten_nr, quelle;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_gesundheit_tot where quelle='AFO' and dubletten_nr is not null;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_gesundheit_tot where quelle='GOOGLE' and dubletten_nr is null;
*/
	...
	aws_s3.query_export_to_s3(
		'	
			select 
				* 
			from 
				google_maps_dev_abgleich.poi_abgleich_google_gesundheit_tot
		', 
   		aws_commons.create_s3_uri(
   			'afo-db-prod-data-exchange', 
   			'google_maps_dev_abgleich/poi_abgleich_google_gesundheit_tot.csv', 
   			'eu-central-1'
   		),
