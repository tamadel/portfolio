...
-- pois number: 18650
create temp table 
	tmp_mobilitaet_category_v1
as
select 
	*
from 
	google_maps_dev.google_map_items_mobilitaet_all t0
where 
	category_ids = 'null'
	or
	exists (
	    ...
	    where
	    	...
	    	and 
	    	t2.hauptkategorie_neu = 'Mobilität'
	)  
;
...
having 
	count(*) > 1
;
select count(*) from tmp_mobilitaet_category_v1;
...
;
select * from tmp_mobilitaet_category;
...
group by 
	...
	,category_ids
;
select * from tmp_google_map_mobilitaet;
...
select
	*
from 
	google_maps_dev.google_map_mobilitaet
;
*/
...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_mobilitaet using GIST(geo_point_lv95);
...
where 
    rn = 1
;
-- select * from tmp_google_map_mobilitaet_v1;
...
update 
	tmp_google_map_mobilitaet_V1 t0
set 
...
--=====================================
drop table if exists 
	google_maps_dev.google_map_mobilitaet_v1;
...
update google_maps_dev.google_map_mobilitaet
set 
	korr_plz4 = '8004'
where 
...
drop table if exists 
	google_maps_dev_abgleich.google_abgleich_mobilitaet;
...
--POIS: Google 
/*
select * from google_maps_dev_abgleich.google_abgleich_mobilitaet order by random() limit 100;

select count(*) from google_maps_dev_abgleich.google_abgleich_mobilitaet;
*/
	
--POIS: AFO
drop table if exists
	google_maps_dev_abgleich.afo_poi_typ_mobilitaet;
...
/*
select * from google_maps_dev_abgleich.afo_poi_typ_mobilitaet order by random() limit 100;

select count(*) from google_maps_dev_abgleich.afo_poi_typ_mobilitaet;
*/
...
(
	'google_maps_dev_abgleich.afo_poi_typ_mobilitaet'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_mobilitaet'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_mobilitaet_tot'			-- abgleich_output_table
)
;

/*
select * from google_maps_dev_abgleich.poi_abgleich_google_mobilitaet_tot order by dubletten_nr, quelle;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_mobilitaet_tot where quelle='AFO' and dubletten_nr is not null;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_mobilitaet_tot where quelle='GOOGLE' and dubletten_nr is not null;
*/
	...
	aws_s3.query_export_to_s3(
		'	
			select 
				* 
			from 
				google_maps_dev_abgleich.poi_abgleich_google_mobilitaet_tot
		', 
   		aws_commons.create_s3_uri(
   			'afo-db-prod-data-exchange', 
   			'google_maps_dev_abgleich/poi_abgleich_google_mobilitaet_tot.csv', 
   			'eu-central-1'
   		),
