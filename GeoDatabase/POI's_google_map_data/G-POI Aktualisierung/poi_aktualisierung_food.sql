...
--===============================================================================
-- FOOD WURDE MANUELL ÜBERARBEITET, DESHALB ÜBERNAHME DIREKT AUS 
-- IMPORT-TABELLE google_maps_dev_abgleich.poi_lieferung_food
--===============================================================================
-- select * from google_maps_dev_abgleich.poi_lieferung_food;
...
from 
	google_maps_dev_abgleich.poi_lieferung_food u
where
...
-------------------------------------------------------------------------------------
-- poi_main_kat_id_list in lay_poi_geo_hist für Food setzen, falls leer
-------------------------------------------------------------------------------------
update
	geo_afo_prod.lay_poi_geo_2024_hist r
set
...
-------------------------------------------------------------------------------------
-- poi_kat_id_list in lay_poi_geo_hist für Food setzen, falls leer
-------------------------------------------------------------------------------------
update
	geo_afo_prod.lay_poi_geo_2024_hist r
set
...
-------------------------------------------------------------------------------------
-- poi_typ_id_list in lay_poi_geo_hist für Food setzen, falls leer
-------------------------------------------------------------------------------------
update
	geo_afo_prod.lay_poi_geo_2024_hist r
set
...
from
	google_maps_dev_abgleich.poi_lieferung_food poi
join (
	select
		hauskey
		,strbezl
...
-------------------------------------------------------------------------------------
-- poi_main_kat_id_list, poi_kat_id_list und poi_typ_id_list in lay_poi_geo_hist für Food setzen
-------------------------------------------------------------------------------------
alter table
	tmp_poi_new
...
-------------------------------------------------------------------------------------
-- company_group auf 'Freier Detaillist' setzen, falls leer
-------------------------------------------------------------------------------------
update 	
	tmp_poi_new
set
	company_group = 'Freier Detaillist'
where
...
select distinct
	t1.company_group_id
	,coalesce(t1.company_group, 'Freier Detaillist') as company_group
	,t0.company_id
	,t0.company
from
	tmp_poi_new t0
...
from
	tmp_poi_update
;
-- select * from geo_afo_prod.lay_poi_geo_2024_hist where created_ts::date = current_date order by created_ts desc;
