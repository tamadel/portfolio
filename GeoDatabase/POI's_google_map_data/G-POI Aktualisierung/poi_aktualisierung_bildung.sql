...
-- select * from google_maps_dev_abgleich.poi_abgleich_google_bildung_tot;
...
from (
	select 
		...
		,a.company
	from
		google_maps_dev_abgleich.poi_abgleich_google_bildung_tot a
	join 
		tmp_poi_gm_match b
	on
		a.poi_id = b.cid
...
/*
 * **********************************************************************************************
 * Es werden keine POIs von Google übernommen!!!!!
 * **********************************************************************************************
*/
/*
-------------------------------------------------------------------------------------
