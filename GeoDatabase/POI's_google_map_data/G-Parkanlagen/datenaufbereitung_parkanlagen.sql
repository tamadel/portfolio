...
-- pois number: 18650
create temp table 
	tmp_parkanlagen_category_v1
as
select 
	*
from 
	google_maps_dev.google_map_items_parkanlagen t0
where 
	category_ids = 'null'
	or
	exists (
	    ...
	    where
	    	...
	    	and 
	    	t2.hauptkategorie_neu = 'Parkanlagen'
	)  
;
select * from google_maps_dev.google_map_items_parkanlagen;
select * from tmp_parkanlagen_category_v1;
...
;
select * from tmp_parkanlagen_category;
...
group by 
	...
	,category_ids
;
select * from tmp_google_map_parkanlagen;
...
select
	*
from 
	google_maps_dev.google_map_parkanlagen
;
*/
...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_parkanlagen using GIST(geo_point_lv95);
...
where 
    rn = 1
;
-- select * from tmp_google_map_parkanlagen_v1;
...
update 
	tmp_google_map_parkanlagen_V1 t0
set 
...
--=====================================
drop table if exists 
	google_maps_dev.google_map_parkanlagen_v1;
...
update google_maps_dev.google_map_parkanlagen
set 
	korr_plz4 = '8004'
where 
...
drop table if exists 
	google_maps_dev_abgleich.google_abgleich_parkanlagen;
...
--POIS: Google 
/*
select * from google_maps_dev_abgleich.google_abgleich_parkanlagen order by random() limit 100;

select count(*) from google_maps_dev_abgleich.google_abgleich_parkanlagen;
*/
	
--POIS: AFO
drop table if exists
	google_maps_dev_abgleich.afo_poi_typ_parkanlagen;
...
/*
select * from google_maps_dev_abgleich.afo_poi_typ_parkanlagen order by random() limit 100;

select count(*) from google_maps_dev_abgleich.afo_poi_typ_parkanlagen;
*/
...
(
	'google_maps_dev_abgleich.afo_poi_typ_parkanlagen'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_parkanlagen'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_parkanlagen_tot'			-- abgleich_output_table
)
;

/*
select * from google_maps_dev_abgleich.poi_abgleich_google_parkanlagen_tot order by dubletten_nr, quelle;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_parkanlagen_tot where quelle='AFO' and dubletten_nr is not null;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_parkanlagen_tot where quelle='GOOGLE' and dubletten_nr is not null;
*/
	...
	aws_s3.query_export_to_s3(
		'	
			select 
				* 
			from 
				google_maps_dev_abgleich.poi_abgleich_google_parkanlagen_tot
		', 
   		aws_commons.create_s3_uri(
   			'afo-db-prod-data-exchange', 
   			'google_maps_dev_abgleich/poi_abgleich_google_parkanlagen_tot.csv', 
   			'eu-central-1'
   		),
