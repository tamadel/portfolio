...
;
-- select * from tmp_dienstleistung_category_v1;
...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_dienstleistung using GIST(geo_point_lv95);
...
update 
	tmp_google_map_dienstleistung_V1 t0
set 
...
--POIS: Google 
/*
select * from google_maps_dev_abgleich.google_abgleich_dienstleistung order by random() limit 100;

select count(*) from google_maps_dev_abgleich.google_abgleich_dienstleistung;
*/
...
/*
select * from google_maps_dev_abgleich.afo_poi_typ_dienstleistung order by random() limit 100;

select count(*) from google_maps_dev_abgleich.afo_poi_typ_dienstleistung;
*/
...
(
	'google_maps_dev_abgleich.afo_poi_typ_dienstleistung'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_dienstleistung'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_dienstleistung_tot'			-- abgleich_output_table
)
;

/*
select * from google_maps_dev_abgleich.poi_abgleich_google_dienstleistung_tot order by dubletten_nr, quelle;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_dienstleistung_tot where quelle='AFO' and dubletten_nr is not null;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_dienstleistung_tot where quelle='AFO' and dubletten_nr is null;
*/
	...
	aws_s3.query_export_to_s3(
		...
		', 
   		aws_commons.create_s3_uri(
   			...
   			'google_maps_dev_abgleich/poi_abgleich_google_dienstleistung_tot.csv', 
   			'eu-central-1'
   		),
