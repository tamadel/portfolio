...
select 
	*
from
	google_maps_dev.google_map_metadata_einkaufszentrum
;
...
select 
	*
from
	google_maps_dev.google_map_results_einkaufszentrum
;
...
select 
	*
from 
	google_maps_dev.google_map_items_einkaufszentrum
;
...
--(4) CATEGORY
--drop table if exists google_maps_dev.google_map_einkaufszentrum; 
select 
	*
from 
...
create temp table tmp_google_map_einkaufszentrum
as 
select
	*
from 
...
update tmp_google_map_einkaufszentrum
set  
    opening_times = case 
...
--=================================
create index idx_tmp_google_map_einkaufszentrum_poly_lv95 on tmp_google_map_einkaufszentrum using GIST(geo_point_lv95);
...
drop table if exists tmp_google_map_einkaufszentrum_V1;
...
create temp table tmp_google_map_einkaufszentrum_V1
as
select 
    cid
    ,bezeichnung
...
alter table tmp_google_map_einkaufszentrum_V1
...
--Korr_plz4
update tmp_google_map_einkaufszentrum_V1
set
	korr_plz4 = plz4
where	
	korr_plz4 IS NULL
...
update tmp_google_map_einkaufszentrum_V1 t0
set 
...
-- 
create temp table tem_google_map_einkaufszentrum_v1
as
select * from google_maps_dev.google_map_einkaufszentrum_v1;

update tem_google_map_einkaufszentrum_v1
set cid = '''' || cid,
	telefon = '''' || telefon
;

select * from tem_google_map_einkaufszentrum_v1;
...
update google_maps_dev.google_map_einkaufszentrum_v1
set 
	korr_plz4 = '8004'
where 
...
drop table if exists google_maps_dev_abgleich.google_abgleich_einkaufszentrum;
create table google_maps_dev_abgleich.google_abgleich_einkaufszentrum
as
select
	 cid as cid 
...
--POIS: Google einkaufszentrum -- to Redshift
select 
	*
from 
...
--POIS: AFO einkaufszentrum -- to Redshift
create table google_maps_dev_abgleich.afo_poi_typ_einkaufszentrum
as
select 
	*
from 
...
where
	poi_typ_id = '504'	--Einkaufszentrum
;	
