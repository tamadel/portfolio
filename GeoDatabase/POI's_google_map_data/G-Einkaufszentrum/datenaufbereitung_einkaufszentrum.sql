...
-- pois number: 18650
create temp table 
	tmp_einkaufszentrum_category_v1
as
select 
	*
from 
	google_maps_dev.google_map_items_einkaufszentrum t0
where 
	category_ids = 'null'
	or
	exists (
	    ...
	    where
	    	...
	    	and 
	    	t2.hauptkategorie_neu = 'Einkaufszentrum'
	)  
;
-- select * from tmp_einkaufszentrum_category_v1;
...
--===============================================
drop table if exists 
	tmp_google_map_einkaufszentrum;
...
select
	...
	,t0.latitude
from 
	tmp_einkaufszentrum_category t0
left join
...
group by 
	...
	,category_ids
;
-- select * from tmp_google_map_einkaufszentrum;
...
select
	*
from 
	google_maps_dev.google_map_einkaufszentrum
;
...
update
	tmp_google_map_einkaufszentrum t0
set
	plz6 = t1.plz6
from
...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_einkaufszentrum using GIST(geo_point_lv95);
...
drop table if exists 
	tmp_google_map_einkaufszentrum_V1;
...
where 
    rn = 1
;
-- select * from tmp_google_map_einkaufszentrum_v1;
...
update 
	tmp_google_map_einkaufszentrum_V1 t0
set 
...
--=====================================
drop table if exists 
	google_maps_dev.google_map_einkaufszentrum_v1;
...
update google_maps_dev.google_map_einkaufszentrum
set 
	korr_plz4 = '8004'
where 
...
--POIS: Google 
/*
select * from google_maps_dev_abgleich.google_abgleich_einkaufszentrum order by random() limit 100;

select count(*) from google_maps_dev_abgleich.google_abgleich_einkaufszentrum;
*/
...
/*
select * from google_maps_dev_abgleich.afo_poi_typ_einkaufszentrum order by random() limit 100;

select * from google_maps_dev_abgleich.afo_poi_typ_einkaufszentrum;
*/
...
(
	'google_maps_dev_abgleich.afo_poi_typ_einkaufszentrum'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_einkaufszentrum'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_einkaufszentrum_tot'			-- abgleich_output_table
)
;

/*
select * from google_maps_dev_abgleich.poi_abgleich_google_einkaufszentrum_tot order by dubletten_nr, quelle;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_einkaufszentrum_tot where quelle='AFO' and dubletten_nr is not null;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_einkaufszentrum_tot where quelle='GOOGLE' and dubletten_nr is not null;
*/
	...
	aws_s3.query_export_to_s3(
		'	
			select 
				* 
			from 
				google_maps_dev_abgleich.poi_abgleich_google_einkaufszentrum_tot
		', 
   		aws_commons.create_s3_uri(
   			'afo-db-prod-data-exchange', 
   			'google_maps_dev_abgleich/poi_abgleich_google_einkaufszentrum_tot.csv', 
   			'eu-central-1'
   		),
