...
/*
SELECT *
FROM geo_afo_prod.afo_poi_typ_food  -- Namen anpassen
LIMIT 10;


SELECT *
FROM geo_afo_prod.afo_poi_typ_food
LIMIT 10;

SELECT *
FROM ex_google_maps_dev.google_abgleich_food --Namen anpassen
LIMIT 100;
...
FROM ex_google_maps_dev.google_abgleich_food
LIMIT 10;
...
-------------------------------
-- Export Tabelle übertragen
-------------------------------

DROP TABLE IF EXISTS 	
	geo_afo_prod.afo_poi_typ_food;
...
SELECT 
	*
FROM 
	ex_google_maps_dev.export_afo_poi_typ_food;
...
ALTER TABLE 
	geo_afo_prod.afo_poi_typ_food
ADD COLUMN 
	geo_point_wgs84 GEOMETRY;

UPDATE 
	geo_afo_prod.afo_poi_typ_food
SET 
	geo_point_lv03 = ST_GeomFromText(geo_point_lv03_text, 21781),
	geo_point_lv95 = ST_GeomFromText(geo_point_lv95_text, 2056 ),	
	geo_point_wgs84 = ST_GeomFromText(geo_point_wgs84_text, 4326)
;

SELECT * FROM geo_afo_prod.afo_poi_typ_food;

CALL geo_afo_prod.sp_abgleich_poi_google();

SELECT * FROM geo_afo_prod.poi_abgleich_google_food_tot WHERE dubletten_nr = '1056460168707860412';

CREATE TABLE 
	ex_google_maps_dev.poi_abgleich_google_food_tot
AS
SELECT 
	*
FROM 
...
from geo_afo_prod.afo_poi_typ_food;  -- Namen anpassen Poi Tabelle
...
select t1.*,
	...
	coalesce(plz_grob, t1.plz4::INT) as plz_grob
from #strasse t1
	left join geo_afo_prod.plz_grob t2 on t1.plz4::INT::TEXT=t2.plz::TEXT;
...
from ex_google_maps_dev.google_abgleich_food; -- Namen anpassen Google Tabelle
...
drop table if exists geo_afo_prod.poi_abgleich_google_food_tot;
create table geo_afo_prod.poi_abgleich_google_food_tot as
select 
...
insert into geo_afo_prod.poi_abgleich_google_food_tot
select 
	T1.cid, 
	0 as hauskey,
	0 as poi_typ_id,
	...
	'GOOGLE' as quelle,
	cast(t2.cid as varchar(1000)) as dubletten_nr 
from ex_google_maps_dev.google_abgleich_food T1 -- Namen anpassen
...
3. Tabelle ex_google_maps_dev.poi_abgleich_google_food_tot exportieren
...
select *
from ex_google_maps_dev.poi_abgleich_google_food_tot
...
/*
-- Table for Peter 
drop table if exists google_maps_dev.poi_abgleich_google_food_tot_csv;
create table google_maps_dev.poi_abgleich_google_food_tot_csv
as
select
	*
from 
...
update google_maps_dev.poi_abgleich_google_food_tot_csv
set poi_id = '''' || poi_id,
	dubletten_nr = '''' || dubletten_nr
;


-- select * from google_maps_dev.poi_abgleich_google_food_tot_csv;
