...
/*
SELECT *
FROM geo_afo_prod.afo_poi_typ_dienstleistung
LIMIT 10;
...
SELECT *
FROM geo_afo_prod.google_abgleich_dienstleistung
LIMIT 100;
...
from geo_afo_prod.afo_poi_typ_dienstleistung;  -- Namen anpassen Poi Tabelle
...
from geo_afo_prod.google_abgleich_dienstleistung; -- Namen anpassen Google Tabelle
...
drop table if exists geo_afo_prod.poi_abgleich_google_dienstleistung_tot;
create table geo_afo_prod.poi_abgleich_google_dienstleistung_tot as
select 
...
insert into geo_afo_prod.poi_abgleich_google_dienstleistung_tot
select 
	T1.cid, 
	0 as hauskey,
	0 as poi_typ_id,
	...
	'GOOGLE' as quelle,
	cast(t2.cid as varchar(1000)) as dubletten_nr 
from geo_afo_prod.google_abgleich_dienstleistung T1 -- Namen anpassen
...
--select distinct cid from geo_afo_prod.google_abgleich_dienstleistung;
...
3. Tabelle geo_afo_prod.poi_abgleich_google_dienstleistung_tot exportieren
...
select *
from geo_afo_prod.poi_abgleich_google_dienstleistung_tot
...
-- Table for Peter 
drop table if exists google_maps_dev.poi_abgleich_google_dienstleistung_tot_csv;
create table google_maps_dev.poi_abgleich_google_dienstleistung_tot_csv
as
select
	*
from 
	geo_afo_prod.poi_abgleich_google_dienstleistung_tot
order by
	dubletten_nr
;	


update google_maps_dev.poi_abgleich_google_dienstleistung_tot_csv
set poi_id = '''' || poi_id,
...
select 
	*
from 
	google_maps_dev.poi_abgleich_google_dienstleistung_tot_csv
;




create table google_maps_dev.poi_abgleich_google_dienstleistung_tot
as
select
	*
from 
