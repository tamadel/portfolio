...
--STEP(9) Final Table
--=====================================
drop table if exists google_maps_dev.google_map_dienstleistung_v1;

create table 
	google_maps_dev.google_map_dienstleistung_v1
as
select 
	cid    
	,bezeichnung 
...
--POIS: Google dienstleistung -- to Redshift
select 
	*
from 
...
--POIS: AFO dienstleistungdienst -- to Redshift
