...
/*
SELECT *
FROM geo_afo_prod.afo_poi_typ_dienstleistung  -- Namen anpassen
LIMIT 10;
...
SELECT *
FROM geo_afo_prod.google_abgleich_dienstleistung --Namen anpassen
LIMIT 100;
...
-- select * from google_maps_dev.poi_abgleich_google_dienstleistung_tot_csv;
