...
-- pois number: 18650
create temp table 
	tmp_<HAUPTKATEGORIE>_category_v1
as
select 
	*
from 
	google_maps_dev.google_map_items_<HAUPTKATEGORIE> t0
where 
	category_ids = 'null'
	or
	exists (
	    ...
	    where
	    	...
	    	and 
	    	t2.hauptkategorie_neu = '<HAUPTKATEGORIE_TEXT>'
	)  
;
...
where 
	hauptkategorie_neu = '<HAUPTKATEGORIE_TEXT>'
;
...
select
	...
	,t0.latitude
from 
	tmp_<HAUPTKATEGORIE>_category t0
left join
...
update
	tmp_google_map_<HAUPTKATEGORIE> t0
set
	plz6 = t1.plz6
from
...
--=================================
create index if not exists idx_tmp_googl_missing_hostel_poly_lv95 on tmp_google_map_<HAUPTKATEGORIE> using GIST(geo_point_lv95);
...
drop table if exists 
	tmp_google_map_<HAUPTKATEGORIE>_V1;
...
where 
    rn = 1
;
-- select * from tmp_google_map_<HAUPTKATEGORIE>_v1;
...
update 
	tmp_google_map_<HAUPTKATEGORIE>_V1 t0
set 
...
--=====================================
drop table if exists 
	google_maps_dev.google_map_<HAUPTKATEGORIE>_v1;
...
update google_maps_dev.google_map_<HAUPTKATEGORIE>
set 
	korr_plz4 = '8004'
where 
...
drop table if exists 
	google_maps_dev_abgleich.google_abgleich_<HAUPTKATEGORIE>;
...
--POIS: Google 
/*
select * from google_maps_dev_abgleich.google_abgleich_<HAUPTKATEGORIE> order by random() limit 100;

select count(*) from google_maps_dev_abgleich.google_abgleich_<HAUPTKATEGORIE>;
*/
	
--POIS: AFO
drop table if exists
	google_maps_dev_abgleich.afo_poi_typ_<HAUPTKATEGORIE>;
...
/*
select * from google_maps_dev_abgleich.afo_poi_typ_<HAUPTKATEGORIE> order by random() limit 100;

select count(*) from google_maps_dev_abgleich.afo_poi_typ_<HAUPTKATEGORIE>;
*/
...
(
	'google_maps_dev_abgleich.afo_poi_typ_<HAUPTKATEGORIE>'						-- afo_poi_input_table
	,'google_maps_dev_abgleich.google_abgleich_<HAUPTKATEGORIE>'					-- google_poi_input_table
	,'google_maps_dev_abgleich.poi_abgleich_google_<HAUPTKATEGORIE>_tot'			-- abgleich_output_table
)
;

/*
select * from google_maps_dev_abgleich.poi_abgleich_google_<HAUPTKATEGORIE>_tot order by dubletten_nr, quelle;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_<HAUPTKATEGORIE>_tot where quelle='AFO' and dubletten_nr is not null;
select count(*) from google_maps_dev_abgleich.poi_abgleich_google_<HAUPTKATEGORIE>_tot where quelle='GOOGLE' and dubletten_nr is null;
*/
	...
	aws_s3.query_export_to_s3(
		...
		', 
   		aws_commons.create_s3_uri(
   			...
   			'google_maps_dev_abgleich/poi_abgleich_google_<HAUPTKATEGORIE>_tot.csv', 
   			'eu-central-1'
   		),
